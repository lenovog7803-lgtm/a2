...
import {
  LayoutDashboard, Package, Users, Truck, CheckSquare, Phone, DollarSign, Menu,
...
export default function TabsLayout() {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      {/* Бургер-меню — скрытый переключатель режимов */}
      <TouchableOpacity
          ...
          <View style={styles.overlay}>
            <TouchableWithoutFeedback>
              <View style={[styles.modeSheet, { top: insets.top + 8, right: 12 }]}>
                ...
                <TouchableOpacity style={styles.modeItem} onPress={switchToTruck}>
                  <Text style={styles.modeItemIcon}>🚛</Text>
