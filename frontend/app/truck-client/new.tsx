...
export default function NewTruckClient() {
  ...
  const [form, setForm] = useState<any>({
    ...
    city_loading: '', city_unloading: '', typical_cargo: '',
    typical_pallets: '', payment_terms: '', notes: '',
  });
  ...
  const save = async () => {
    ...
    try {
      ...
      await api.truck.clients.create(payload);
      router.back();
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Field label="Типичное кол-во паллет" value={form.typical_pallets} onChangeText={v => set('typical_pallets', v)} keyboardType="numeric" />
